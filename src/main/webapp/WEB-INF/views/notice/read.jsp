	...
	<div class="container">
	    <form role="form" method="post" autocomplete="off">
	        ...
	        <input type="hidden" id="searchType" name="searchType" value="${scri.searchType}" readonly="readonly">
	         ...
	         <input type="hidden" id="no_num" name="no_num" value="${read.no_num}" />
	        ...
	        <table class="table table-hover">
	            ...
	            <tbody>
	                <tr>
	                    ...
	                    <td>${read.userId}</td>
	                    <td>
	                        <fmt:formatDate value="${read.no_date}" pattern="yyyy-MM-dd" />
	                    </td>
	                    <td>${read.no_readCount}</td>
	                </tr>
	                <tr>
	                    <td colspan="5">${read.no_content }</td>
	                </tr>
	            </tbody>
	        </table>
	    </form>
		...
		<div>
	        ...
	        <u>
	            ...
	            <form role="form" method="post" autocomplete="off">
	                <input type="hidden" id="no_num" name="no_num" value="${read.no_num}" readonly="readonly" />
	                <input type="hidden" id="page" name="page" value="${scri.page}" readonly="readonly" />
	                <input type="hidden" id="perPageNum" name="perPageNum" value="${scri.perPageNum}" readonly="readonly" />
	                <input type="hidden" id="searchType" name="searchType" value="${scri.searchType}" readonly="readonly" />
	                <input type="hidden" id="keyword" name="keyword" value="${scri.keyword}" readonly="readonly" />
