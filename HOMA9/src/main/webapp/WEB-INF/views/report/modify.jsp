				...
				<div>
					<div>
						<label>제목</label> <input type="text" class="form-control"
							required="required" name="rp_subject" value="${modify.rp_subject }">
					</div>
					<div>
						<label>신고대상 아이디 : </label> <input type="text" class="form-control"
							required="required" name="rp_reportId" value="${modify.rp_reportId }">
					</div>
					
					<div>
						<label>신고대상 URL : </label> <input class="form-control"
							required="required" name="rp_reportArticle" type="url" value="${modify.rp_reportArticle }">
					</div>
			
					<div>
						<label>내용</label>  <textarea class="form-control"
							required="required" name="rp_content">${modify.rp_content }</textarea>		
					</div>
