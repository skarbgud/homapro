	...
	<!-- 모달창 -->
		...
		<form role="form" class="form-horizontal" method="post" autocomplete="off" onsubmit="return validate();">
			<div class="form-group" id="divId">
				...
				<div class="col-lg-8">
					<input type="text" class="form-control onlyAlphabetAndNumber" id="userId" name="userId" data-rule-required="true" placeholder="30자이내의 알파벳, 언더스코어(_), 숫자만 입력 가능합니다." maxlength="30" required="required">
				</div>
				<div class="col-lg-2">
            ...
            <div class="form-group" id="divKakao">
                   ...
                   <div class="col-lg-10">
                       <input type="text" class="form-control" id="kakao" name="kakao" data-rule-required="true" placeholder="카카오톡 아이디" maxlength="20" required="required" >
                   </div>
			</div>
			...
			<div class="form-group">
                    ...
                    <div class="form-group">
	                    <div class="col-lg-offset-2 col-lg-10">
	                        <button type="submit" id="signup_btn" name="signup_btn"  class="submit btn btn-primary">Sign in</button>
	                    </div>
                	</div>
