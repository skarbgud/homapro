...
<body>
	...
	<div class="container">
		...
		<form role="form" class="form-horizontal" method="post"
				...
				<div class="col-lg-10">
					<div class="col-md-5">
						<label class="checkbox-inline"> 
							<input type="checkbox" name="mat_food" id="food1" value="한식" readonly="readonly" class="mat_food"/>한식
						</label> 
						<label class="checkbox-inline"> 
			...
			<button type="submit" class="col-lg-offset-5 col-lg-1  btn btn-primary" id="matchingRead_btn" class="myButton"
			OnClick="javascript:history.back(-1)">취소</button>
			<button type="submit" class="col-lg-offset-5 col-lg-1  btn btn-primary" id="modity_btn" class="myButton" style="margin-left: 30px;">수정</button>
			<script>
			// 폼을 변수에 저장
