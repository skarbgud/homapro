...
<body>
	...
	<section id="loginFormArea">
		<img src="../../resources/images/homa.png" width="50px" height="70px"
			...
			style="margin-left: 25px; font-size: 20px; margin-bottom: 10px;">비밀번호
			찾기 </label>
		...
		<div id="sessionlogin">
			<section id="container">
				<div id="container_box">
					<section id="content">
						<form role="form" autocomplete="off" action = "passwordmodify">
							<div class="input_area">
								<label for="userPass">변경할 비밀번호 : </label> <input type="password"
									id="userPass" name="userPass" required="required"/>
							</div>
							<button type="submit" id="signup_btn" name="signup_btn" class ="submit">변경하기</button>
						</form>
					</section>
				</div>
			</section>
