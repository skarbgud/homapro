	...
	<div class="container">
		...
		<div class="form-group">
			<h2>나의 매칭 정보</h2>
				...
				<form role="form">
					<button type="button" id="matchingModity_btn" class="btn btn-warning">수정</button>
					<button type="button" id="matchingDelete_btn" class="btn btn-danger">삭제</button>
					<script>
					var formObj = $("form[role='form']");
					// 삭제 버튼 클릭
	                $("#matchingDelete_btn").click(function() {
	                    formObj.attr("action", "/matching/matchingDelete");
	                    formObj.attr("method", "get");
	                    formObj.submit();
	                });
	             
						// 수정 버튼 클릭
						$("#matchingModity_btn").click(function() {
							formObj.attr("action", "/matching/matchingModify");
							formObj.attr("method", "get");
							formObj.submit();
						});
					</script>
		...
		<form role="form" class="form-horizontal" method="post" autocomplete="off" onsubmit="return CheckForm(this)">
			...
			<div class="form-group">
				<label for="job" class="col-lg-2 control-label">직업</label>
				<div class="col-lg-8">
					<div class="col-md-2">
			...
			<!-- 취침시간-->
			<div class="form-group">
				<label for="bedTime" class="col-lg-2 control-label">취침시간</label>
				<div class="col-lg-8">
					<div class="col-md-2">
						<h5>${matchingVO.mat_bedTime}</h5>
					</div>

					<!-- 중요도 -->
					<div class="col-md-4" id="important">
							<h5><strong>중요도 : ${matchingVO.mat_bedTimeDetail }</strong></h5>
					</div>
				<!-- 중요도끝 -->
				</div>
			</div>
