...
<body>
   ...
   <section class="container">
       ...
       <ul class="list-unstyled">
          ...
          <c:forEach items="${black}" var="black">
             <li>
               <div class="checkBox">
                  <input type="checkbox" name="chBox" class="chBox" data-userId="${black.userId}" />
               ...
               <div class="userInfo">                  
                  ...
                  <div class="delete">
                     <button type="button" class="delete${black.userId}_btn" data-userId="${black.userId}">삭제</button>
                      <script>
                         $(".delete${black.userId}_btn").click(function(){
                               var confirm_val = confirm("정말 삭제하시겠습니까?");
