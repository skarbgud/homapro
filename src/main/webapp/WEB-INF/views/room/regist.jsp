...
<!-- <script type="text/javascript">
	function doOpenKindCheck(chk) {
		var obj = document.getElementsByName("r_kind");
	...
	function doOpenSpeciesCheck(chk) {
		var obj = document.getElementsByName("r_species");
		for (var i = 0; i < obj.length; i++) {
			if (obj[i] != chk) {
				obj[i].checked = false;
			}
	...
	function doOpenAvailableCheck(chk) {
		var obj = document.getElementsByName("r_available");
		for (var i = 0; i < obj.length; i++) {
			if (obj[i] != chk) {
				obj[i].checked = false;
			}
...
<body>  
  ...
  <header id="header">
	...
	<!--   -->
   	<form role="form"  autocomplete="off" method="POST"  class="form-inline" enctype="multipart/form-data" onsubmit="return checkForm(this)">
  	 <div id = "main" class="container-fluid">
   		<div class="row">
   			<div class="col-lg-offset-2 col-lg-8">
			      <h2 class="text-center"><b>방등록</b></h2>
			      ...
			      <div class="col-md-12 form-group">
			      	<div class="row">
		      			...
		      			<div class="col-md-3 border text-center">
			      			...
			      			<!--  onclick="doOpenSpeciesCheck(this);" -->
			      ...
			      <div class="col-md-12 form-group">
			      	<div class="row">
		      			...
		      			<div class="col-md-3 border text-center">
			      			...
			      			<!-- onclick=" doOpenAvailableCheck(this);" -->
		      			<div class="col-md-9 border text-center" style="padding-top: 2px;padding-bottom: 3px;"  data-toggle="buttons">
		      				<label class="btn btn-default">		      		
				      			<input type="radio" name="r_available" class="availableCheck" value="남자" />남자
			      			</label>
			      			
			      			<label class="btn btn-default">
			      				<input type="radio" name="r_available" class="availableCheck" value="여자"/>여자
			      			</label>	
			      			
			      			<label class="btn btn-default">
				      			<input type="radio" name="r_available" class="availableCheck" value="상관없음"/>상관없음
			      			</label>	
		      			</div>
			      	</div>
			      </div>
			   ...
			   <!-- 이미지업로드 -->
			      ...
			      <div class="col-md-12 form-group">
			      	<div class="row">
		      			...
		      			<div class="col-md-9 border text-center" style="padding-top: 2px;padding-bottom: 3px;" >
		      				<textarea name="r_content" class="form-control noresize" rows="7" style="width: 365px;" required="required"></textarea>
		      			</div>
			      	</div>
			      </div>			      	
			      <!-- 방 상세설명 -->
			      ...
			      <!-- 카톡아이디 -->
    			  <input type="hidden" name="r_kakao" value="${member.kakao}">
