	...
	<div class="container">
		...
		<form role="form" class="form-horizontal" method="post"
			...
			<div class="form-group">
				...
				<div class="col-lg-8">
					<div class="col-md-3">
						<select class="form-control" name="mat_workStart">
							<option>01시</option>
							<option>02시</option>
							<option>03시</option>
							<option>04시</option>
					...
					<div class="col-md-3">
						<select class="form-control" name="mat_workEnd">
							<option>01시</option>
							<option>02시</option>
							<option>03시</option>
							<option>04시</option>
					...
					<div class="col-md-4" id="important">
						...
						<input name="mat_workDetail" id="mat_workDetail" type="range"
							min="0" value="0" max="5" step="1" list="list1"
							oninput="Output1.value = mat_workDetail.value" />
				...
				<div class="col-lg-10">
					<div class="col-md-5">
						<label class="checkbox-inline"> <input type="checkbox"
							name="mat_food" id="food1" value="한식" readonly="readonly"/>한식
						</label> <label class="checkbox-inline"> <input type="checkbox"
							name="mat_food" id="food2" value="중식" />중식
						</label> <label class="checkbox-inline"> <input type="checkbox"
							name="mat_food" id="food3" value="양식" />양식
						</label> <label class="checkbox-inline"> <input type="checkbox"
							name="mat_food" id="food4" value="일식" />일식
						</label>
					</div>
